...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h2>عذرًا. الصفحة التي كنت تبحث عنها غير موجودة.</h2>
			<h6>قد تكون قد قمت بكتابة العنوان بشكل خاطئ أو ربما تم نقل الصفحة.</h6><a class="btn btn-outline-danger" href="{{ url('/' . $page='index') }}">العودة إلى الصفحة الرئيسية</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
